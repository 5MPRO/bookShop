...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 04, 2022 lúc 03:30 AM
...
(1, 15, 2, 'Thám Tử Kindaichi R - Tập 1', 22000, 1, 'Đã duyệt'),
(2, 16, 1, 'Pokemon Pippi trọn bộ 14 tập', 1172000, 4, 'Đã duyệt'),
(3, 16, 6, 'CHUỘC TỘI', 291000, 3, 'Đã duyệt'),
(4, 20, 1, 'Pokemon Pippi trọn bộ 14 tập', 293000, 1, 'Đã duyệt'),
(5, 18, 2, 'Thám Tử Kindaichi ', 22000, 1, 'Đã duyệt'),
(6, 19, 12, 'Mối tình đầu', 1404000, 6, 'Đã duyệt'),
(7, 22, 2, 'Thám Tử Kindaichi ', 22000, 1, 'Đã duyệt'),
(8, 23, 2, 'Thám Tử Kindaichi ', 22000, 1, 'Đã duyệt'),
(9, 24, 16, 'Big Data', 368000, 4, 'Chờ xử lý');
...
(24, 'thanhnhan', 394921219, 'user', 'Tam Anh Nam');
...
(3, 0, 'thanhnhan', 'user', '1', 394921219, 'Tam Anh Nam', '27/20/2001'),
